...
export const CreepyButton = ({
    ...
    return (
        ...
        >
            ...
            <motion.span
                className={cn(
                    "absolute inset-0 block rounded-xl bg-purple-600 hover:bg-purple-500 border border-purple-400/50 shadow-[inset_0_0_0_0.125em_rgba(255,255,255,0.2)] text-white font-bold tracking-wider transition-colors",
